...
esp_ble_adv_data_t hidd_adv_data = {
    ...
    .appearance = 0x03c0,       //HID Generic,	ESP_HID_APPEARANCE_KEYBOARD
//	.appearance = 0x03C1,		//键盘
//	.appearance = 0x03C2,		//鼠标
    .manufacturer_len = 0,
...
void ble_init(void)
{
    ...
    esp_ble_auth_req_t auth_req = ESP_LE_AUTH_REQ_SC_ONLY;     //bonding with peer device after authentication
