...
static const uint8_t hidReportMap[] = {
    ...
    0x75, 0x04,   //     Report Size (4)				bit0~bit3
    0x95, 0x01,   //     Report Count (1)			
    ...
    0x75, 0x02,   //   Report Size (2)					bit4~bit5
    0x95, 0x01,   //   Report Count (1)
    0x81, 0x46,   //   Input (Data, Var, Rel, Null)
    0x09, 0xE9,   //   Usage (Volume Up)				拍照
    0x09, 0xEA,   //   Usage (Volume Down)
    0x15, 0x00,   //   Logical Min (0)
    0x75, 0x01,   //   Report Size (1)					bit6~bit7
    ...
    0x75, 0x04,   //   Report Size (4)					bit8~bit11
    0x95, 0x01,   //   Report Count (1)
    0x81, 0x00,   //   Input (Data, Ary, Abs)
    ...
    0x75, 0x02,   //     Report Size (2)				bit12~bit13
    0x81, 0x00,   //     Input (Data, Ary, Abs)
    0xC0,         //   End Collection
    0x81, 0x03,   //   Input (Const, Var, Abs)			bit14~bit15 const
...
static void hid_add_id_tbl(void)
{
     // Mouse input report
	  ...
	  printf("Key headle =	%d,Report ID = %d,type = %d\r\n",hid_rpt_map[1].handle,hid_rpt_map[1].id,hid_rpt_map[1].type);
	  ...
	  printf("Consumer headle =	%d,Report ID = %d,type = %d\r\n",hid_rpt_map[2].handle,hid_rpt_map[2].id,hid_rpt_map[2].type);
      // LED output report
	  ...
	  printf("LED headle =	%d,Report ID = %d,type = %d\r\n",hid_rpt_map[3].handle,hid_rpt_map[3].id,hid_rpt_map[3].type);
	  ...
	  printf("Feature headle =	%d,Report ID = %d,type = %d\r\n",hid_rpt_map[7].handle,hid_rpt_map[7].id,hid_rpt_map[7].type);
/************************新添加**************************/
//多媒体控制映射表封装
#ifdef	DUOMEITI
